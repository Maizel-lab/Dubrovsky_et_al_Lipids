...
```{r}
Fig1 <- (panel_img_pip4 + panel_img_pi45p2) /(pip4 + pip45p2) +
...
FigS2 <- FigS2_a + FigS2_b + FigS2_c + plot_annotation(tag_levels = 'A') & theme(plot.tag = element_text(size = 18, face='bold'))
FigS2
```
...
```{r}
ggsave("Figures/Supplemental/FigS2/FigS2.png",
       FigS2,
       limitsize = FALSE,
       units = c("cm"),
       width = 30, height = 15, bg = "white")

ggsave("Figures/Supplemental/FigS2/FigS2.pdf",
       FigS2,
       limitsize = FALSE,
       units = c("cm"),
       width = 30, height = 15)
...
Fig5 <- panel_img_idepp + panel_img_proXPP + panel_img_proGATA +  fig5_LRD_plot + fig5_Stages_plot+
  plot_layout(design = layout,
              heights = c(1/3, 2/3),
...
FigS3 <-  panel_img_1 + panel_img_2 +fig5_LRD_plot_a + fig5_LRD_plot_b +
  plot_layout(design = layout,
              heights = c(1/2, 1/2))+
  plot_annotation(tag_levels = 'A') & theme(plot.tag = element_text(size = 18, face='bold'))
FigS3
